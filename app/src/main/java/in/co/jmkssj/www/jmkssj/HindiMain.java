...
public class HindiMain extends AppCompatActivity  implements  BaseSliderView.OnSliderClickListener,ViewPagerEx.OnPageChangeListener  {
    Toolbar toolbar;
    TextView textView,appTitle;
    SliderLayout sliderLayout;
    HashMap<String, Integer> HashMapForURL;
    RelativeLayout viewSuggestion,viewDonation,viewMembership,viewMap,viewFounder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Typeface typeface = Typeface.createFromAsset(getAssets(),"fonts/DevLys 330 Condensed.ttf");
        ...
        for (String name : HashMapForURL.keySet()) {
            TextSliderView textSliderView = new TextSliderView(HindiMain.this);
            textSliderView
                    .description(name)
        ...
        sliderLayout.addOnPageChangeListener(HindiMain.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.share) {
            Toast.makeText(HindiMain.this, "Share clicked", Toast.LENGTH_LONG).show();
            return true;
        }
        if (id == R.id.login) {
            Toast.makeText(HindiMain.this, "Login clicked", Toast.LENGTH_LONG).show();
            return true;
        }
